...
namespace Engine
{
	...
	*/
	...
	private:
		...
		glm::vec2 m_localPosition; //!< The local position of the text to the entity
	...
	public:
		Text(const char* text, const glm::vec4& tint, const char* fontName, const glm::vec2& localPos, const float localOrientation, const glm::vec2& localScale); //!< Constructor
		~Text(); //!< Destructor
		...
		bool containsPoint(const glm::vec2& coordinate); //!< Returns whether the point is inside this text render's bounding box
