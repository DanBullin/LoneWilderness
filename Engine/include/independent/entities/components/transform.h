...
namespace Engine
{
	...
	*/
	...
	public:
		...
		glm::vec3 getWorldPosition(); //!< Get the position of the entity in the world
		glm::vec3 getLocalPosition(); //!< Get the position of the entity in local space
		void setLocalPosition(const float xPos, const float yPos, const float zPos); //!< Set the position of the entity in the world
		void setLocalPosition(const glm::vec3& newPos); //!< Set the position of the entity in the world
		...
		float distance(const glm::vec3& pos); //!< Get the distance between this transform and the position of another
		float angle(Transform* otherTransform); //!< Get the angle between this transform and another based on camera's front direction
		float angle(const glm::vec3& pos); //!< Get the angle between this transform and another based on camera's front direction
